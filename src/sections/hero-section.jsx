    ...
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            >
                ...
                <span>One account, multiple modes</span>
            </motion.a>
            ...
            >
                <span className="bg-gradient-to-r from-green-400 via-purple-400 to-orange-400 text-transparent bg-clip-text">
                    Claverit
                </span>
                <br />
                <span className="text-4xl md:text-5xl text-slate-200">A Trusted Digital Platform by WINSMILES</span>
            </motion.h1>
            <motion.p className="text-center text-base text-slate-300 max-w-2xl mt-4"
                initial={{ y: 50, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Secure communication, verified contacts, smart commerce, and community support — all in one app.
            </motion.p>
            ...
            >
                <button className="flex items-center gap-2 bg-gradient-to-r from-blue-900 to-blue-600 hover:from-blue-950 hover:to-blue-700 transition text-white active:scale-95 rounded-lg px-7 h-11">
                    Get started
